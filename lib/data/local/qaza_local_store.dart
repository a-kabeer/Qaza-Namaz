...
abstract interface class QazaLocalStore {
  ...
  Future<QazaHistoryPage> getHistoryPage({
    ...
    records = records.where((r) {
      ...
      return (prayerType == null || r.prayerType == prayerType) &&
          (status == null || r.status == status) &&
          (originalDateFrom == null || !date.isBefore(originalDateFrom)) &&
          (originalDateTo == null || !date.isAfter(originalDateTo));
    }).toList()
      ..sort((a, b) {
    ...
    var start = 0;
    if (cursor != null) {
      final index = records.indexWhere((r) => r.id == cursor);
