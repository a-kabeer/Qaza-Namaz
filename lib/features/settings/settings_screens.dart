            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                SegmentedButton<bool>(
                  segments: const [ButtonSegment(value: false, icon: Icon(Icons.language_outlined), label: Text('English')), ButtonSegment(value: true, label: Text('اردو (Soon)'), enabled: false)],
...
class FiqhScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => PageScaffold(title: 'Prayer & Fiqh Rules', child: ListView(padding: const EdgeInsets.all(16), children: const [
...
class AboutScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => PageScaffold(title: 'About', child: ListView(padding: const EdgeInsets.all(16), children: const [
