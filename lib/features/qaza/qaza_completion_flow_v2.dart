...
class CompleteQazaV2Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<CompleteQazaV2Screen> createState() => _CompleteQazaV2ScreenState();
}
...
class PendingDatesV2Screen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PendingDatesV2Screen> createState() => _PendingDatesV2ScreenState();
}
...
class _EmptyCompletionState extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => const Padding(padding: EdgeInsets.all(8), child: Column(children: [Icon(Icons.check_circle_outline_rounded, size: 40), SizedBox(height: 10), Text('No pending Qaza for this prayer.'), SizedBox(height: 4), Text('Choose another prayer or add a Qaza record first.')]));
}

class _EmptyPendingDates extends StatelessWidget {
  const _EmptyPendingDates();
  @override
  Widget build(BuildContext context) => const Card(child: Padding(padding: EdgeInsets.all(20), child: Column(children: [Icon(Icons.inbox_outlined, size: 40), SizedBox(height: 10), Text('No pending Qaza records.'), SizedBox(height: 4), Text('This prayer is currently up to date.')]));
}
