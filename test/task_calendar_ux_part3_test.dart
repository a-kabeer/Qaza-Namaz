...
void main() {
                ...
                builder: (context, ref, child) => Column(
                  children: [
                    SegmentedButton<DateSelectionMode>(
                      ...
                      selected: {
                        ref.watch(calendarControllerProvider).selectionMode
                      },
  ...
  testWidgets('range selection shows both selected Gregorian dates',
      (tester) async {
  ...
  testWidgets('multiple selection lists every selected Gregorian date',
      (tester) async {
