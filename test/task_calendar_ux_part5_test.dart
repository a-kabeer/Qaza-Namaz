...
void main() {
  testWidgets('calendar uses theme tokens for selection surfaces', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [calendarTodayProvider.overrideWithValue(DateTime(2027, 3, 15))],
        child: MaterialApp(
  ...
  testWidgets('calendar remains readable with dark theme', (tester) async {
    ...
    final summary = tester.widget<Card>(find.byKey(const Key('calendar_selected_summary')));
