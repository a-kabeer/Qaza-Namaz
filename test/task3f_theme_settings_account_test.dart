...
void main() {
  ...
  testWidgets('Settings navigation opens Account and lists companion sections', (tester) async {
    ...
    expect(find.text('Account'), findsNWidgets(2)); expect(find.text('Prayer & Fiqh Rules'), findsOneWidget); expect(find.text('Notifications'), findsWidgets); expect(find.text('Data & Cloud'), findsOneWidget); expect(find.text('About'), findsOneWidget); expect(find.byType(SettingsNavRow), findsNWidgets(5));
