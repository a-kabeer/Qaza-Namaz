...
void main() {
  testWidgets('Signed-out onboarding opens complete authentication entry',
  ...
  testWidgets('Create Account exposes confirmation field and switches back to Sign In',
      (WidgetTester tester) async {
    await _openAuth(tester);
  ...
  testWidgets('Phone verification flow opens and validates code entry',
      (WidgetTester tester) async {
    await _openAuth(tester);
