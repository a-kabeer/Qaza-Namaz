...
import 'package:qaza_namaz/core/widgets/date_display.dart';
...
void main() {
  ...
  group('Completion widget', () {
    testWidgets(
      'loads the latest record without a full-ledger read and completes it',
      (tester) async {
        ...
        await tester.pumpWidget(
          ProviderScope(
            ...
            child: const TestApp(home: CompleteQazaHost()),
          ),
        );
        await tester.pumpAndSettle();

        // The section shows the latest pending record for the selected
        // prayer, with the Gregorian date leading, padded and with its year.
        expect(find.text(formatAppDate(DateTime(2026, 1, 3))), findsOneWidget);
        expect(
